...
export const createProject = async (req: Request, res: Response) => {
    ...
    try {
        ...
        //generate the image usung the ai model
...
export const createVideo = async (req: Request, res: Response) => {
    ...
    try {
        // Use findFirst because combined id and userId is not a unique index
        ...
        const prompt = `make the person showcase the project which is ${project.productName} ${project.productDescription && `and Product Description: ${project.productDescription}`}`
        ...
        //update project status and error message
        // Use updateMany because combined id and userId is not a unique index
